      ...
      <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 p-6 hover:scale-105 transition-all duration-300">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-red-600">{{ $totalCoupons }}</p>
          </div>
      ...
      <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 p-6 hover:scale-105 transition-all duration-300">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-sm text-gray-500 mt-1">{{ $totalCoupons > 0 ? round(($activeCoupons / $totalCoupons) * 100, 1) : 0 }}% من الإجمالي</p>
          </div>
              ...
              @forelse($couponUsage as $coupon)
                <tr class="hover:bg-gray-50 transition-colors duration-200">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-gray-900 font-medium">
                    {{ number_format($coupon->total_discount, 2) }} ريال
                  </td>
                </tr>
              @empty
                <tr>
