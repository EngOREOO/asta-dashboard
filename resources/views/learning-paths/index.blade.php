        ...
        <tbody class="bg-white divide-y divide-gray-200">
          @foreach($paths as $path)
            <tr class="hover:bg-gray-50 transition-colors duration-200">
              <td class="px-6 py-4 whitespace-nowrap font-medium text-gray-900" style="font-size: 1.3rem;">{{ $path->id }}</td>
                ...
                <div class="flex items-center">
                  ...
                  <div class="mr-4">
                    <div class="font-medium text-gray-900" style="font-size: 1.3rem;">
                      <a href="{{ route('learning-paths.show', $path) }}" class="hover:text-blue-600 transition-colors duration-200">
                        {{ $path->name }}
                      </a>
                    </div>
                  </div>
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                @if($path->average_rating > 0)
                  <div class="flex items-center">
                    <span class="text-yellow-400 mr-1">
                      <i class="ti ti-star-filled text-sm"></i>
                    </span>
                    <span class="text-gray-900" style="font-size: 1.3rem;">{{ $path->average_rating }}/5</span>
                  </div>
                @else
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                @if($path->total_price > 0)
                  <span class="inline-flex items-center px-2.5 py-0.5 rounded-full font-medium bg-blue-100 text-blue-800" style="font-size: 1.3rem;">
                     {{ $path->formatted_price }}
              ...
              <td class="px-6 py-4 whitespace-nowrap font-medium" style="font-size: 1.3rem;">
                <div class="flex items-center space-x-2 space-x-reverse">
                  ...
                  <form action="{{ route('learning-paths.destroy', $path) }}" method="POST" class="inline" onsubmit="return confirm('هل أنت متأكد من حذف هذا المسار؟')">
                    @csrf
                    @method('DELETE')
                    <button type="submit" 
