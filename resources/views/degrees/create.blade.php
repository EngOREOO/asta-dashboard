...
<div class="min-h-screen bg-gradient-to-br from-teal-50 via-cyan-50 to-blue-100 font-arabic">
  <div class="space-y-8 p-6">
    ...
    <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 animate-slide-up">
      ...
      <div class="p-8">
        <form action="{{ route('degrees.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-3 gap-6">
          @csrf
          ...
          <div>
            ...
            <input id="code" name="code" type="text" value="{{ old('code') }}" placeholder="EX-123" class="w-full border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500" style="font-size: 1.3rem; font-family: Arial, sans-serif;">
          ...
          <div>
            ...
            <input id="credit_hours" name="credit_hours" type="number" value="{{ old('credit_hours') }}" class="w-full border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500" style="font-size: 1.3rem;" min="0">
