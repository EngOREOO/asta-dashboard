...
<div class="min-h-screen bg-gradient-to-br from-teal-50 via-cyan-50 to-blue-100 font-arabic">
  <div class="space-y-8 p-6">
    ...
    <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 animate-slide-up">
      ...
      <div class="p-8">
        <!-- Filters -->
        <form method="GET" action="<?php echo e(route('users.index')); ?>" class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end mb-6">
          <div>
            <label class="block text-gray-700 mb-2" style="font-size: 1.3rem;">بحث</label>
            <input type="text" name="search" value="<?php echo e($filters['search'] ?? ''); ?>" class="w-full border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500" style="font-size: 1.3rem;" placeholder="ابحث بالاسم أو البريد">
          </div>
          <div>
            ...
            <select name="role" class="w-full border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500" style="font-size: 1.3rem;">
              ...
              <?php $__currentLoopData = Spatie\Permission\Models\Role::query()->pluck('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                ?>
                <option value="<?php echo e($role); ?>" <?php if(($filters['role'] ?? '') === $role): echo 'selected'; endif; ?>><?php echo e($arabicRole); ?></option>
          ...
          <table class="admin-table" id="users-table">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              <tr class="hover:bg-gray-50 transition-colors duration-200">
                <td class="px-6 py-4 whitespace-nowrap font-medium text-gray-900 text-center" style="font-size: 1.3rem;"><?php echo e($user->id); ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-center">
                  <?php if($user->profile_photo_path && Storage::disk('public')->exists($user->profile_photo_path)): ?>
                    <img src="<?php echo e(asset('storage/' . $user->profile_photo_path)); ?>" alt="<?php echo e($user->name); ?>" class="h-12 w-12 rounded-lg shadow-sm object-cover border-2 border-gray-200">
                  <?php else: ?>
                    <div class="h-12 w-12 rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center shadow-sm">
                      <img src="<?php echo e(asset('images/asta-logo.png')); ?>" alt="ASTA Logo" class="w-6 h-6 object-contain opacity-80">
                    </div>
                  <?php endif; ?>
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-rtl">
                  <div class="font-medium text-gray-900" style="font-size: 1.3rem;"><?php echo e($user->name); ?></div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-ltr">
                  <div class="text-gray-900 email-content" style="font-size: 1.3rem;"><?php echo e($user->email); ?></div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-rtl" style="font-size: 1.3rem;">
                  ...
                  ?>
                  <?php echo e(implode(', ', $arabicRoles) ?: '—'); ?>

                </td>
                <td class="px-6 py-4 whitespace-nowrap text-rtl text-gray-900" style="font-size: 1.3rem;"><?php echo e(optional($user->created_at)->format('Y-n-j')); ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-center">
                  <form action="<?php echo e(route('users.toggle-active', $user)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <button type="submit" class="inline-flex items-center px-3 py-1.5 rounded-full text-sm <?php echo e($user->is_active ? 'bg-emerald-100 text-emerald-700' : 'bg-gray-100 text-gray-700'); ?>">
                      <i class="ti <?php echo e($user->is_active ? 'ti-toggle-right' : 'ti-toggle-left'); ?> ml-1"></i>
                ...
                <td class="px-6 py-4 whitespace-nowrap font-medium text-center" style="font-size: 1.3rem;">
                  <div class="flex items-center space-x-2 space-x-reverse">
                    <a href="<?php echo e(route('users.show', $user)); ?>" class="inline-flex items-center px-3 py-2 border border-transparent leading-4 font-medium rounded-lg text-blue-700 bg-blue-100 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200" style="font-size: 1.3rem;" title="عرض">
                      <i class="ti ti-eye text-sm"></i>
                    </a>
                    <a href="<?php echo e(route('users.edit', $user)); ?>" class="inline-flex items-center px-3 py-2 border border-transparent leading-4 font-medium rounded-lg text-gray-700 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors duration-200" style="font-size: 1.3rem;" title="تعديل">
...
<?php echo $__env->make('layouts.dash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmed\Documents\asta\asss\resources\views/users/index.blade.php ENDPATH**/ ?>