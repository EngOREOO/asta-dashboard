    ...
    <div class="mb-8">
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          ...
          <div>
            <h1 class="font-bold text-gray-800" style="font-size: 2rem;"><?php echo e($partner->name); ?></h1>
        ...
        <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 animate-slide-up">
          ...
          <div class="p-8 space-y-6">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 font-semibold" style="font-size: 1.3rem;"><?php echo e($partner->name); ?></p>
            </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 leading-relaxed"><?php echo e($partner->description); ?></p>
            </div>
            <?php endif; ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
                ...
                <span class="inline-flex items-center px-4 py-2 rounded-xl bg-purple-100 text-purple-800 font-semibold">
                  <i class="ti ti-hash mr-2"></i><?php echo e($partner->sort_order ?? 0); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
                ...
                <p class="text-gray-700 font-semibold">
                  <?php echo e($partner->created_at ? $partner->created_at->format('Y/m/d - H:i') : 'غير محدد'); ?>
              ...
              <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
                ...
                <p class="text-gray-700 font-semibold">
                  <?php echo e($partner->updated_at ? $partner->updated_at->format('Y/m/d - H:i') : 'غير محدد'); ?>
          ...
          <div class="p-8">
            <?php if($partner->image): ?>
              <div class="text-center">
                ...
                <p class="text-gray-600 mt-4 font-semibold">شعار <?php echo e($partner->name); ?></p>
              </div>
            <?php else: ?>
              <div class="text-center">
...
<?php echo $__env->make('layouts.dash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmed\Documents\asta\asss\resources\views/partners/show.blade.php ENDPATH**/ ?>