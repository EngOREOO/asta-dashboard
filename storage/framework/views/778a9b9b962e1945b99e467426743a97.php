    ...
    <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 p-6 hover:scale-105 transition-all duration-300 animate-slide-up">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-4xl font-bold text-indigo-600"><?php echo e(number_format($totalBandwidth, 0)); ?> GB</p>
...
new Chart(bandwidthCtx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: <?php echo json_encode($chartData['bandwidth'], 15, 512) ?>,
...
<?php echo $__env->make('layouts.dash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmed\Documents\asta\asss\resources\views/reports/bandwidth-consumption/index.blade.php ENDPATH**/ ?>