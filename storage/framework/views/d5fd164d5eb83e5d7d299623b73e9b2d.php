...
<div class="min-h-screen bg-gradient-to-br from-teal-50 via-cyan-50 to-blue-100 font-arabic">
  <div class="space-y-8 p-6">
    ...
    <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 animate-slide-up">
      ...
      <div class="p-8">
        <form action="<?php echo e(route('question-bank.store')); ?>" method="POST" class="space-y-8" style="font-size: 1.3rem;">
          <?php echo csrf_field(); ?>
          ...
          <div class="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-2xl border border-gray-200">
            ...
            <textarea id="question" name="question" rows="4" class="w-full border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 shadow-sm transition-all duration-200 hover:shadow-md focus:shadow-lg" style="font-size: 1.3rem;" required placeholder="اكتب نص السؤال هنا..."><?php echo e(old('question')); ?></textarea>
            <?php $__errorArgs = ['question'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-600 mt-2 flex items-center" style="font-size: 1.2rem;"><i class="ti ti-alert-circle mr-1"></i><?php echo e($message); ?></p><?php unset($message);
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-2xl border border-blue-200">
              ...
              <select id="type" name="type" class="w-full border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 shadow-sm transition-all duration-200 hover:shadow-md focus:shadow-lg" style="font-size: 1.3rem;" required>
                ...
                <option value="multiple_choice" <?php echo e(old('type') == 'multiple_choice' ? 'selected' : ''); ?>>اختيارات متعددة</option>
                <option value="multiple_choice_two" <?php echo e(old('type') == 'multiple_choice_two' ? 'selected' : ''); ?>>اختيارات متعددة إجابتين</option>
                <option value="true_false" <?php echo e(old('type') == 'true_false' ? 'selected' : ''); ?>>صح/خطأ</option>
                <option value="text" <?php echo e(old('type') == 'text' ? 'selected' : ''); ?>>نصي</option>
              </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-2xl border border-green-200">
              ...
              <input type="number" id="points" name="points" min="1" class="w-full border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 shadow-sm transition-all duration-200 hover:shadow-md focus:shadow-lg" style="font-size: 1.3rem;" value="<?php echo e(old('points')); ?>" required placeholder="مثال: 5">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-gradient-to-r from-orange-50 to-amber-50 p-6 rounded-2xl border border-orange-200">
              ...
              <select id="difficulty" name="difficulty" class="w-full border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 shadow-sm transition-all duration-200 hover:shadow-md focus:shadow-lg" style="font-size: 1.3rem;">
                ...
                <option value="easy" <?php echo e(old('difficulty') == 'easy' ? 'selected' : ''); ?>>سهل</option>
                <option value="medium" <?php echo e(old('difficulty') == 'medium' ? 'selected' : ''); ?>>متوسط</option>
                <option value="hard" <?php echo e(old('difficulty') == 'hard' ? 'selected' : ''); ?>>صعب</option>
              </select>
...
<?php echo $__env->make('layouts.dash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmed\Documents\asta\asss\resources\views/question-bank/create.blade.php ENDPATH**/ ?>