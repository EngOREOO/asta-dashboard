...
unset($__errorArgs, $__bag); ?>
              ...
              <div>
                ...
                <select id="status" 
                  ...
                  <option value="pending" <?php if(old('status') === 'pending'): echo 'selected'; endif; ?>>في انتظار الموافقة</option>
                  <?php if(auth()->user()->hasRole('admin')): ?>
                  <option value="approved" <?php if(old('status') === 'approved'): echo 'selected'; endif; ?>>موافق عليها</option>
                  <?php endif; ?>
                </select>
              </div>
            </div>
