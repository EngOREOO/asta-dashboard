                        ...
                        <div class="space-y-3">
                            <?php if($courseMaterial->type === 'video' && $courseMaterial->file_path): ?>
                                <div class="p-4 border border-gray-200 rounded-2xl bg-black/5">
                                    <video controls class="w-full rounded-xl shadow" style="max-height: 520px;">
                                        <source src="<?php echo e(asset('storage/' . $courseMaterial->file_path)); ?>" type="video/mp4">
                                        متصفحك لا يدعم تشغيل الفيديو. <a href="<?php echo e(asset('storage/' . $courseMaterial->file_path)); ?>" class="text-blue-600 underline">تحميل الملف</a>
                                    </video>
                                </div>
                            <?php endif; ?>
                            <?php if($courseMaterial->file_path): ?>
                                <div class="flex items-center justify-between p-4 border border-gray-200 rounded-xl">
                                    ...
                                    <?php if (isset($component)) { $__componentOriginal60a020e5340f3f52bbc4501dc9f93102 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal60a020e5340f3f52bbc4501dc9f93102 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.button','data' => ['variant' => 'primary','size' => 'sm','href' => ''.e(asset('storage/' . $courseMaterial->file_path)).'','target' => '_blank']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','size' => 'sm','href' => ''.e(asset('storage/' . $courseMaterial->file_path)).'','target' => '_blank']); ?>
