...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 p-8 mb-10 hover:shadow-2xl transition-all duration-300 cursor-pointer font-arabic" onclick="window.location.href='<?php echo e(route('admin.testimonials')); ?>'">
...
function editTestimonialFromDashboard(id) {
    ...
    window.location.href = `<?php echo e(route('admin.testimonials')); ?>?edit=${id}`;
}
