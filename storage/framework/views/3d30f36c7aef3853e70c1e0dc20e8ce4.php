...
<?php $__env->startSection('content'); ?>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center space-x-4 rtl:space-x-reverse text-cyan-100">
                        <div class="flex items-center space-x-2 rtl:space-x-reverse">
                            ...
                            <span style="font-size: 1.3rem;" id="current-date"><?php echo e(now()->format('Y-n-j')); ?></span>
                        </div>
                        <div class="flex items-center space-x-2 rtl:space-x-reverse">
                            <i class="ti ti-clock text-xl"></i>
                            <span style="font-size: 1.3rem;" id="current-time"><?php echo e(now()->format('h:i A')); ?></span>
                        </div>
                    </div>
                </div>
        ...
        <div class="group bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 p-8 hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer">
            <div class="flex items-center justify-between mb-6">
                <div class="text-right flex-1">
                    ...
                    <p class="text-4xl font-bold bg-gradient-to-r from-teal-600 to-cyan-600 bg-clip-text text-transparent text-center"><?php echo e(number_format($totalUsers)); ?></p>
                </div>
        ...
        <div class="group bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 p-8 hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer">
            <div class="flex items-center justify-between mb-6">
                <div class="text-right flex-1">
                    ...
                    <p class="text-4xl font-bold bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent text-center"><?php echo e(number_format($totalCourses)); ?></p>
                </div>
        ...
        <div class="group bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 p-8 hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer">
            <div class="flex items-center justify-between mb-6">
                <div class="text-right flex-1">
                    ...
                    <p class="text-4xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent text-center"><?php echo e(number_format($totalInstructors)); ?></p>
                </div>
            ...
            <div class="flex items-center justify-between mb-6">
                <div class="text-right flex-1">
                    ...
                    <p class="text-4xl font-bold bg-gradient-to-r from-indigo-600 to-blue-700 bg-clip-text text-transparent text-center">
                        <?php echo e(number_format($totalEnrollments * 29.99)); ?>

                        <img src="<?php echo e(asset('riyal.svg')); ?>" alt="ريال" class="w-8 h-8 inline mr-2">
                    </p>
                </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 p-8 hover:shadow-2xl transition-all duration-300">
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between p-4 bg-teal-50 rounded-2xl">
                    ...
                    <span class="text-lg font-bold text-teal-600" style="font-size: 1.40rem;"><?php echo e($pendingCourses); ?></span>
                </div>
                <div class="flex items-center justify-between p-4 bg-cyan-50 rounded-2xl">
                    ...
                    <span class="text-lg font-bold text-cyan-600"><?php echo e($pendingApplications); ?></span>
                </div>
                <div class="flex items-center justify-between p-4 bg-blue-50 rounded-2xl">
                    ...
                    <span class="text-lg font-bold text-blue-600"><?php echo e($pendingReviews); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 p-8 hover:shadow-2xl transition-all duration-300">
            ...
            <div class="space-y-4">
                <a href="<?php echo e(route('active-users.index')); ?>" class="block">
                    <div class="flex items-center justify-between p-4 bg-green-50 rounded-2xl hover:bg-green-100 transition-colors cursor-pointer">
                        ...
                        <div class="flex items-center space-x-2 rtl:space-x-reverse">
                            <span class="text-lg font-bold text-green-600"><?php echo e(number_format($activeUsersCount)); ?></span>
                ...
                <div class="flex items-center justify-between p-4 bg-cyan-50 rounded-2xl">
                    ...
                    <span class="text-lg font-bold text-cyan-600"><?php echo e(number_format($totalMaterials)); ?></span>
                </div>
                <div class="flex items-center justify-between p-4 bg-blue-50 rounded-2xl">
                    <div class="flex items-center space-x-3 rtl:space-x-reverse">
                        <div class="w-8 h-8 bg-blue-100 rounded-xl flex items-center justify-center">
                    ...
                    <span class="text-lg font-bold text-blue-600"><?php echo e(number_format($totalAssessments)); ?></span>
                </div>
                <div class="flex items-center justify-between p-4 bg-indigo-50 rounded-2xl">
                    ...
                    <span class="text-lg font-bold text-indigo-600"><?php echo e(number_format($totalEnrollments)); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 p-8 hover:shadow-2xl transition-all duration-300">
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between p-4 bg-teal-50 rounded-2xl">
                    ...
                    <span class="text-lg font-bold text-teal-600"><?php echo e(number_format($totalCertificates)); ?></span>
                </div>
                <div class="flex items-center justify-between p-4 bg-cyan-50 rounded-2xl">
                    <div class="flex items-center space-x-3 rtl:space-x-reverse">
                        <div class="w-8 h-8 bg-cyan-100 rounded-xl flex items-center justify-center">
                    ...
                    <span class="text-lg font-bold text-cyan-600"><?php echo e(number_format($totalPartners)); ?></span>
                </div>
                <div class="flex items-center justify-between p-4 bg-blue-50 rounded-2xl">
                    <div class="flex items-center space-x-3 rtl:space-x-reverse">
                        <div class="w-8 h-8 bg-blue-100 rounded-xl flex items-center justify-center">
                    ...
                    <span class="text-lg font-bold text-blue-600"><?php echo e(number_format($totalComments)); ?></span>
                </div>
                <div class="flex items-center justify-between p-4 bg-purple-50 rounded-2xl">
                    ...
                    <span class="text-lg font-bold text-purple-600"><?php echo e(number_format($totalTestimonials)); ?></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 p-8 hover:shadow-2xl transition-all duration-300">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="<?php echo e(route('courses.index')); ?>" class="text-sm text-teal-600 hover:text-teal-700 font-semibold bg-teal-50 px-4 py-2 rounded-xl hover:bg-teal-100 transition-all duration-300">
                    عرض الكل
                </a>
            </div>
            ...
            <?php if($recentCourses->count() > 0): ?>
                <div class="space-y-4">
                    <?php $__currentLoopData = $recentCourses->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="group flex items-center space-x-4 rtl:space-x-reverse p-4 rounded-2xl hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 transition-all duration-300 cursor-pointer">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="font-semibold text-gray-900 truncate" style="font-size: 1.2rem;"><?php echo e($course->title); ?></p>
                                <p class="text-gray-500" style="font-size: 1.3rem;">
                                    <?php echo e($course->instructor ? $course->instructor->name : 'محاضرغير محدد'); ?> • 
                                    <?php echo e($course->created_at->diffForHumans()); ?>

                                </p>
                            </div>
                            <div class="flex-shrink-0">
                                <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold <?php echo e($course->status === 'approved' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                                    <?php echo e($course->status === 'approved' ? 'معتمد' : 'معلق'); ?>
        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 p-8 hover:shadow-2xl transition-all duration-300">
            ...
            <?php if($recentActivities->count() > 0): ?>
                <div class="space-y-4">
                    <?php $__currentLoopData = $recentActivities->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="group flex items-center space-x-4 rtl:space-x-reverse p-4 rounded-2xl hover:bg-gradient-to-r hover:from-cyan-50 hover:to-blue-50 transition-all duration-300 cursor-pointer">
                            <div class="w-12 h-12 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg group-hover:shadow-xl transition-all duration-300">
                                <i class="ti ti-<?php echo e($activity->icon); ?> text-white text-lg"></i>
                            </div>
                            <div class="flex-1 min-w-0">
                                <p class="font-semibold text-gray-900" style="font-size: 1.2rem;"><?php echo e($activity->description); ?></p>
                                <p class="text-gray-500" style="font-size: 1.3rem;"><?php echo e($activity->created_at->diffForHumans()); ?></p>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 p-8 mb-10 hover:shadow-2xl transition-all duration-300 cursor-pointer font-arabic" onclick="window.location.href='<?php echo e(route('admin.testimonials.index')); ?>'">
            ...
            <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-100">
                <div class="flex items-center justify-between mb-6">
                    <div class="text-right flex-1">
                        ...
                        <p class="text-3xl font-bold text-purple-900 text-center"><?php echo e(number_format($totalTestimonials)); ?></p>
                    </div>
            ...
            <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-100">
                <div class="flex items-center justify-between mb-6">
                    <div class="text-right flex-1">
                        ...
                        <p class="text-3xl font-bold text-green-900 text-center"><?php echo e(number_format($approvedTestimonials)); ?></p>
                    </div>
            ...
            <div class="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-6 border border-yellow-100">
                <div class="flex items-center justify-between mb-6">
                    <div class="text-right flex-1">
                        ...
                        <p class="text-3xl font-bold text-yellow-900 text-center"><?php echo e(number_format($pendingTestimonials)); ?></p>
                    </div>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100">
                <div class="flex items-center justify-between mb-6">
                    <div class="text-right flex-1">
                        ...
                        <p class="text-3xl font-bold text-blue-900 text-center"><?php echo e($averageRating); ?>/5</p>
                    </div>
        ...
        <!-- Recent Testimonials -->
        <?php if($recentTestimonials->count() > 0): ?>
            <div>
                <h4 class="font-semibold text-gray-900 mb-6" style="font-size: 1.19rem;">أحدث آراء العملاء</h4>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__currentLoopData = $recentTestimonials->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white rounded-2xl border border-gray-100 p-6 hover:shadow-lg transition-all duration-300 cursor-pointer" onclick="event.stopPropagation(); editTestimonialFromDashboard(<?php echo e($testimonial->id); ?>)">
                            <div class="flex items-start space-x-4 rtl:space-x-reverse mb-4">
                                <div class="flex-shrink-0">
                                    <?php if($testimonial->user_image_url): ?>
                                        <img src="<?php echo e($testimonial->user_image_url); ?>" alt="<?php echo e($testimonial->user_name); ?>" class="w-12 h-12 rounded-full object-cover">
                                    <?php else: ?>
                                        <div class="w-12 h-12 rounded-full bg-gradient-to-br from-purple-400 to-pink-400 flex items-center justify-center">
                                            <span class="text-white font-semibold text-lg"><?php echo e(substr($testimonial->user_name, 0, 1)); ?></span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <h5 class="font-semibold text-gray-900 truncate" style="font-size: 1.19rem;"><?php echo e($testimonial->user_name); ?></h5>
                                    <div class="flex items-center mt-1">
                                        <?php for($i = 1; $i <= 5; $i++): ?>
                                            <i class="ti ti-star<?php echo e($i <= $testimonial->rating ? '-filled' : ''); ?> text-sm <?php echo e($i <= $testimonial->rating ? 'text-yellow-400' : 'text-gray-300'); ?>"></i>
                                        <?php endfor; ?>
                                        <span class="text-sm text-gray-500 mr-2">(<?php echo e($testimonial->rating); ?>/5)</span>
                                    </div>
                                </div>
                            </div>
                            <p class="text-gray-600 leading-relaxed line-clamp-3" style="font-size: 1.3rem;"><?php echo e(Str::limit($testimonial->comment, 120)); ?></p>
                            <div class="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
                                <span class="text-xs text-gray-500"><?php echo e($testimonial->created_at->diffForHumans()); ?></span>
                                <?php if($testimonial->is_featured): ?>
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                        <i class="ti ti-star-filled mr-1"></i>مميزة
                                    </span>
                                <?php elseif($testimonial->is_approved): ?>
    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 p-8 mb-10 font-arabic">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <a href="<?php echo e(route('courses.create')); ?>" class="group">
            ...
            <a href="<?php echo e(route('instructors.index')); ?>" class="group">
            ...
            <a href="<?php echo e(route('analytics.index')); ?>" class="group">
...
function editTestimonialFromDashboard(id) {
    ...
    window.location.href = `<?php echo e(route('admin.testimonials.index')); ?>?edit=${id}`;
}
...
<?php echo $__env->make('layouts.dash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmed\Documents\asta\asss\resources\views/dashboard/index.blade.php ENDPATH**/ ?>