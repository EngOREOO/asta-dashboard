      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          ...
          <div>
            ...
            <p class="text-gray-600" style="font-size: 1.1rem;">تفاصيل شهادة <?php echo e($testimonial->user_name); ?></p>
          </div>
        </div>
        <div class="flex items-center space-x-4 rtl:space-x-reverse">
          <a href="<?php echo e(route('testimonials.edit', $testimonial)); ?>" 
        ...
        <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 mb-8">
          ...
          <div class="p-8">
            ...
            <div class="flex items-center mb-8">
              ...
              <div>
                <h3 class="font-bold text-gray-800 text-2xl"><?php echo e($testimonial->user_name); ?></h3>
                <div class="flex items-center mt-2">
                  <?php for($i = 1; $i <= 5; $i++): ?>
                    ...
                    <?php endif; ?>
                  <?php endfor; ?>
                  <span class="mr-3 text-gray-600 font-semibold text-lg"><?php echo e($testimonial->rating); ?>/5</span>
                </div>
              </div>
            </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 text-lg leading-relaxed"><?php echo e($testimonial->comment); ?></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="space-y-8">
          ...
          <div class="p-6 space-y-4">
            ...
            <div class="flex items-center justify-between">
              ...
              <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold
                <?php echo e($testimonial->is_approved ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                <i class="ti ti-<?php echo e($testimonial->is_approved ? 'check-circle' : 'clock'); ?> mr-1"></i>
                <?php echo e($testimonial->is_approved ? 'موافق عليه' : 'في الانتظار'); ?>
            ...
            <div class="flex items-center justify-between">
              ...
              <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold
                <?php echo e($testimonial->is_featured ? 'bg-purple-100 text-purple-800' : 'bg-gray-100 text-gray-800'); ?>">
                <i class="ti ti-star mr-1"></i>
                <?php echo e($testimonial->is_featured ? 'مميز' : 'عادي'); ?>
        ...
        <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20">
          ...
          <div class="p-6 space-y-4">
            <div class="flex items-center justify-between">
              ...
              <span class="text-gray-600"><?php echo e($testimonial->created_at->format('Y-m-d H:i')); ?></span>
            </div>
            <div class="flex items-center justify-between">
              <span class="text-gray-700 font-semibold">آخر تحديث:</span>
              <span class="text-gray-600"><?php echo e($testimonial->updated_at->format('Y-m-d H:i')); ?></span>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20">
          ...
          <div class="p-6 space-y-3">
            <!-- Toggle Approval -->
            <button onclick="toggleApproval(<?php echo e($testimonial->id); ?>)" 
                    class="w-full bg-<?php echo e($testimonial->is_approved ? 'yellow' : 'green'); ?>-100 text-<?php echo e($testimonial->is_approved ? 'yellow' : 'green'); ?>-700 px-4 py-3 rounded-xl font-semibold hover:bg-<?php echo e($testimonial->is_approved ? 'yellow' : 'green'); ?>-200 transition-all duration-300">
              <i class="ti ti-<?php echo e($testimonial->is_approved ? 'ban' : 'check'); ?> mr-2"></i>
              <?php echo e($testimonial->is_approved ? 'إلغاء الموافقة' : 'الموافقة'); ?>

            </button>

            <!-- Toggle Featured -->
            <button onclick="toggleFeatured(<?php echo e($testimonial->id); ?>)" 
                    class="w-full bg-<?php echo e($testimonial->is_featured ? 'gray' : 'purple'); ?>-100 text-<?php echo e($testimonial->is_featured ? 'gray' : 'purple'); ?>-700 px-4 py-3 rounded-xl font-semibold hover:bg-<?php echo e($testimonial->is_featured ? 'gray' : 'purple'); ?>-200 transition-all duration-300">
              <i class="ti ti-star mr-2"></i>
              <?php echo e($testimonial->is_featured ? 'إلغاء التمييز' : 'تمييز'); ?>

            </button>

            <!-- Delete -->
            <form action="<?php echo e(route('testimonials.destroy', $testimonial)); ?>" method="POST" 
...
<?php echo $__env->make('layouts.dash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmed\Documents\asta\asss\resources\views/testimonials/show.blade.php ENDPATH**/ ?>