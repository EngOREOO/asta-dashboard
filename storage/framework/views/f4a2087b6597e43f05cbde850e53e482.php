  ...
  <div class="space-y-8 p-6">
        ...
        <form method="GET" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
          ...
          <div>
            ...
            <select name="status" class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300">
              ...
              <option value="enrolled" <?php echo e($status == 'enrolled' ? 'selected' : ''); ?>>مسجل</option>
              <option value="in_progress" <?php echo e($status == 'in_progress' ? 'selected' : ''); ?>>قيد التقدم</option>
          ...
          <div class="flex items-end">
            <a href="<?php echo e(route('admin.reports.attendance')); ?>" class="w-full bg-gray-500 hover:bg-gray-600 text-white px-6 py-3 rounded-xl text-center shadow-lg hover:shadow-xl transition-all duration-300">
      ...
      <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 p-6 hover:scale-105 transition-all duration-300">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-blue-600"><?php echo e(number_format($totalStudents)); ?></p>
          </div>
      ...
      <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 p-6 hover:scale-105 transition-all duration-300">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-green-600"><?php echo e(number_format($activeStudents)); ?></p>
          </div>
      ...
      <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 p-6 hover:scale-105 transition-all duration-300">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-purple-600"><?php echo e(number_format($attendanceRate, 1)); ?>%</p>
          </div>
      ...
      <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 p-6 hover:scale-105 transition-all duration-300">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-orange-600"><?php echo e(number_format($completionRate, 1)); ?>%</p>
          </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-slide-up">
      ...
      <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20">
        ...
        <div class="p-8">
          <div class="space-y-4">
            <?php $__currentLoopData = $attendanceByCourse->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl hover:shadow-lg transition-all duration-300">
              <div class="flex-1">
                <h4 class="font-semibold text-gray-900 text-lg"><?php echo e($course->title); ?></h4>
                <p class="text-sm text-gray-600"><?php echo e($course->total_enrollments); ?> تسجيل</p>
              </div>
              <div class="text-left">
                <p class="text-sm font-medium text-green-600"><?php echo e($course->completed_students); ?> مكتمل</p>
                <p class="text-xs text-gray-500"><?php echo e(number_format($course->avg_progress, 1)); ?>% متوسط التقدم</p>
              </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
      ...
      <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20">
        ...
        <div class="p-8">
          <div class="space-y-4">
            <?php $__currentLoopData = $attendanceByInstructor->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instructor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl hover:shadow-lg transition-all duration-300">
              <div class="flex-1">
                <h4 class="font-semibold text-gray-900 text-lg"><?php echo e($instructor->instructor_name); ?></h4>
                <p class="text-sm text-gray-600"><?php echo e($instructor->total_enrollments); ?> تسجيل</p>
              </div>
              <div class="text-left">
                <p class="text-sm font-medium text-green-600"><?php echo e($instructor->completed_students); ?> مكتمل</p>
                <p class="text-xs text-gray-500"><?php echo e(number_format($instructor->avg_progress, 1)); ?>% متوسط التقدم</p>
              </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              <tr class="hover:bg-gray-50 transition-colors duration-200">
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 font-medium"><?php echo e($activity->student_name); ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($activity->course_title); ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                  <div class="flex items-center">
                    <div class="w-full bg-gray-200 rounded-full h-2 mr-2">
                      <div class="bg-gradient-to-r from-blue-500 to-purple-500 h-2 rounded-full" style="width: <?php echo e($activity->progress ?? 0); ?>%"></div>
                    </div>
                    <span class="text-sm font-medium"><?php echo e($activity->progress ?? 0); ?>%</span>
                  </div>
                </td>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                  <?php echo e($activity->updated_at ? \Carbon\Carbon::parse($activity->updated_at)->diffForHumans() : 'غير محدد'); ?>
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-100">
              ...
              <tr class="hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 transition-all duration-300 border-b border-gray-100">
                <td class="px-6 py-5 whitespace-nowrap text-sm text-gray-900 font-semibold"><?php echo e($enrollment->student_name ?? 'غير محدد'); ?></td>
                <td class="px-6 py-5 whitespace-nowrap text-sm text-gray-700"><?php echo e($enrollment->student_email ?? 'غير محدد'); ?></td>
                <td class="px-6 py-5 whitespace-nowrap text-sm text-gray-900 font-medium"><?php echo e($enrollment->course_title ?? 'غير محدد'); ?></td>
                <td class="px-6 py-5 whitespace-nowrap text-sm text-gray-700"><?php echo e($enrollment->instructor_name ?? 'غير محدد'); ?></td>
                <td class="px-6 py-5 whitespace-nowrap text-sm text-gray-900">
                  <div class="flex items-center">
                    <div class="w-full bg-gray-200 rounded-full h-3 mr-3 shadow-inner">
                      <div class="bg-gradient-to-r from-blue-500 to-purple-500 h-3 rounded-full shadow-sm transition-all duration-500" style="width: <?php echo e($enrollment->progress ?? 0); ?>%"></div>
                    </div>
                    <span class="text-sm font-bold text-gray-800 min-w-[3rem]"><?php echo e($enrollment->progress ?? 0); ?>%</span>
                  </div>
                </td>
                <td class="px-6 py-5 whitespace-nowrap text-sm text-gray-700"><?php echo e($enrollment->created_at ? \Carbon\Carbon::parse($enrollment->created_at)->format('Y-m-d') : 'غير محدد'); ?></td>
                <td class="px-6 py-5 whitespace-nowrap text-sm text-gray-700"><?php echo e($enrollment->completed_at ? \Carbon\Carbon::parse($enrollment->completed_at)->format('Y-m-d') : '-'); ?></td>
...
<script>
    ...
    const monthlyData = <?php echo json_encode($attendanceByMonth, 15, 512) ?>;
    ...
    const courseData = <?php echo json_encode($attendanceByCourse->take(5), 15, 512) ?>;
...
<?php echo $__env->make('layouts.dash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmed\Documents\asta\asss\resources\views/reports/attendance/index.blade.php ENDPATH**/ ?>