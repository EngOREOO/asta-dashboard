    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between animate-fade-in">
      <div class="space-y-2">
        ...
        <p class="text-gray-600 flex items-center" style="font-size: 1.3rem;">
          ...
          إدارة مسارات التعلم والدورات المتسلسلة
        </p>
      </div>
    ...
    <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 animate-slide-up">
      <div class="bg-gradient-to-r from-teal-500 via-cyan-500 to-blue-600 px-8 py-6 relative overflow-hidden">
        ...
        <div class="relative z-10">
          ...
          <p class="text-blue-100 mt-2" style="font-size: 1.3rem;">عرض وإدارة جميع مسارات التعلم</p>
        </div>
        <!-- Decorative elements -->
      ...
      <div class="p-8">
        <?php if($paths->count() > 0): ?>
        <div class="table-responsive">
          <table class="table table-hover" id="learning-paths-table">
        <thead class="bg-gray-50">
          <tr>
            ...
            <th class="px-6 py-4 text-right font-medium text-black uppercase tracking-wider" style="font-size: 1.3rem;">التقييم المتوسط</th>
            <th class="px-6 py-4 text-right font-medium text-black uppercase tracking-wider" style="font-size: 1.3rem;">السعر الإجمالي</th>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          <?php $__currentLoopData = $paths; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $path): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="hover:bg-gray-50 transition-colors duration-200">
              <td class="px-6 py-4 whitespace-nowrap font-medium text-gray-900" style="font-size: 1.3rem;"><?php echo e($path->id); ?></td>
                ...
                <div class="flex items-center">
                  <div class="flex-shrink-0 h-10 w-10">
                    <div class="h-10 w-10 rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center shadow-sm">
                      <i class="ti ti-route text-white text-lg"></i>
                    </div>
                  </div>
                  <div class="mr-4">
                    <div class="font-medium text-gray-900" style="font-size: 1.3rem;">
                      <a href="<?php echo e(route('learning-paths.show', $path)); ?>" class="hover:text-blue-600 transition-colors duration-200">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full font-medium bg-blue-100 text-blue-800" style="font-size: 1.3rem;">
                  <?php echo e($path->courses_count); ?> دورة
                </span>
              </td>
              <td class="px-6 py-4 whitespace-nowrap">
                <?php if($path->average_rating > 0): ?>
                  <div class="flex items-center">
                    <span class="text-yellow-400 mr-1">
                      <i class="ti ti-star-filled text-sm"></i>
                    </span>
                    <span class="text-gray-900" style="font-size: 1.3rem;"><?php echo e($path->average_rating); ?>/5</span>
                  </div>
                <?php else: ?>
                  <span class="text-gray-400" style="font-size: 1.3rem;">لا توجد تقييمات</span>
                <?php endif; ?>
              </td>
              <td class="px-6 py-4 whitespace-nowrap">
                <?php if($path->total_price > 0): ?>
                  <span class="inline-flex items-center px-2.5 py-0.5 rounded-full font-medium bg-blue-100 text-blue-800" style="font-size: 1.3rem;">
                     <?php echo e($path->formatted_price); ?>
              ...
              <td class="px-6 py-4 whitespace-nowrap font-medium" style="font-size: 1.3rem;">
                <div class="flex items-center space-x-2 space-x-reverse">
                  ...
                  <form action="<?php echo e(route('learning-paths.destroy', $path)); ?>" method="POST" class="inline" onsubmit="return confirm('هل أنت متأكد من حذف هذا المسار؟')">
                    <?php echo csrf_field(); ?>
        ...
        <!-- Pagination -->
        <?php if($paths->hasPages()): ?>
          <div class="mt-6 flex justify-center">
            <?php echo e($paths->links()); ?>
        ...
        <div class="text-center py-12">
          <div class="mb-6">
            <div class="w-24 h-24 bg-gradient-to-r from-blue-100 to-purple-100 rounded-full flex items-center justify-center mx-auto">
              <i class="ti ti-route text-4xl text-blue-500"></i>
            </div>
          </div>
          <h3 class="font-medium text-gray-900 mb-2" style="font-size: 1.9rem;">لا توجد مسارات تعلم</h3>
          <p class="text-gray-500 mb-6" style="font-size: 1.3rem;">ابدأ بإنشاء مسار تعلم جديد لتنظيم الدورات.</p>
          <a href="<?php echo e(route('learning-paths.create')); ?>" 
            ...
            <i class="ti ti-plus mr-2"></i>إنشاء مسار جديد
          </a>
        </div>
        <?php endif; ?>
      </div>
...
<script>
  window.addEventListener('DOMContentLoaded', function () {
    ...
    if (window.jQuery && jQuery.fn.DataTable) {
      jQuery('#learning-paths-table').DataTable({
        pageLength: 10,
...
<?php echo $__env->make('layouts.dash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmed\Documents\asta\asss\resources\views/learning-paths/index.blade.php ENDPATH**/ ?>