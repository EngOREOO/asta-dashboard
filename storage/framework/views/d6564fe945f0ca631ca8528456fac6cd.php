            ...
            <select id="department" name="department" class="w-full border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500" style="font-size: 1.3rem;">
              ...
              <?php if(isset($categories)): ?>
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($cat->name); ?>" <?php if(old('department')===$cat->name): echo 'selected'; endif; ?>><?php echo e($cat->name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              <?php endif; ?>
            </select>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="md:col-span-2">
            ...
            <div id="phones-wrapper" class="space-y-2">
              ...
              <?php $__currentLoopData = $oldPhones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $phone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex gap-2">
                  <input name="phones[<?php echo e($idx); ?>]" type="text" value="<?php echo e($phone); ?>" class="flex-1 w-full border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500" style="font-size: 1.3rem;">
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="md:col-span-2">
            ...
            <div id="socials-wrapper" class="space-y-2">
              ...
              <?php $__currentLoopData = $oldSocials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                  <input name="social_links[<?php echo e($idx); ?>][platform]" type="text" value="<?php echo e($social['platform'] ?? ''); ?>" placeholder="المنصة (مثال: تويتر، لينكدإن)" class="w-full border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500" style="font-size: 1.3rem;">
                  <div class="flex gap-2">
                    <input name="social_links[<?php echo e($idx); ?>][url]" type="url" value="<?php echo e($social['url'] ?? ''); ?>" placeholder="الرابط" class="flex-1 w-full border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500" style="font-size: 1.3rem;">
