  ...
  <div class="relative z-10 space-y-8 p-6">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between animate-fade-in">
      ...
      <div class="flex flex-col sm:flex-row gap-3">
        <a href="<?php echo e(route('admin.marketing.create')); ?>" class="group relative overflow-hidden bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white px-8 py-4 rounded-2xl flex items-center shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
          <div class="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          <i class="ti ti-plus ml-3 text-lg"></i>
          <span class="font-semibold text-lg">حملة جديدة</span>
        </a>
        <a href="<?php echo e(route('admin.marketing.templates')); ?>" class="group relative overflow-hidden bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white px-8 py-4 rounded-2xl flex items-center shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
          <div class="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          <i class="ti ti-template ml-3 text-lg"></i>
          <span class="font-semibold text-lg">القوالب</span>
        </a>
        <a href="<?php echo e(route('admin.marketing.analytics')); ?>" class="group relative overflow-hidden bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white px-8 py-4 rounded-2xl flex items-center shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
          <div class="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
      ...
      <div class="group relative overflow-hidden bg-white/80 backdrop-blur-2xl rounded-3xl border border-white/30 shadow-2xl hover:shadow-3xl transition-all duration-700 hover:scale-105 hover:-translate-y-2">
        ...
        <div class="relative p-8">
          ...
          <div class="space-y-2">
            ...
            <p class="text-4xl font-black text-gray-900"><?php echo e(number_format($totalStudents)); ?></p>
      ...
      <div class="group relative overflow-hidden bg-white/80 backdrop-blur-2xl rounded-3xl border border-white/30 shadow-2xl hover:shadow-3xl transition-all duration-700 hover:scale-105 hover:-translate-y-2">
        ...
        <div class="relative p-8">
          ...
          <div class="space-y-2">
            ...
            <p class="text-4xl font-black text-gray-900"><?php echo e(number_format($totalInstructors)); ?></p>
            <p class="text-sm text-gray-500 font-medium">متاح للإرسال</p>
          </div>
          <div class="mt-6 w-full bg-gray-200 rounded-full h-2">
      ...
      <div class="group relative overflow-hidden bg-white/80 backdrop-blur-2xl rounded-3xl border border-white/30 shadow-2xl hover:shadow-3xl transition-all duration-700 hover:scale-105 hover:-translate-y-2">
        ...
        <div class="relative p-8">
          ...
          <div class="space-y-2">
            ...
            <p class="text-4xl font-black text-gray-900"><?php echo e(number_format($totalUsers)); ?></p>
      ...
      <div class="group relative overflow-hidden bg-white/80 backdrop-blur-2xl rounded-3xl border border-white/30 shadow-2xl hover:shadow-3xl transition-all duration-700">
        ...
        <div class="relative">
          ...
          <div class="p-8">
            ...
            <div class="space-y-4">
              <a href="<?php echo e(route('admin.marketing.create')); ?>" class="group/btn w-full bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white px-8 py-4 rounded-2xl flex items-center justify-center shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
        ...
        <div class="relative">
          ...
          <div class="p-8">
            <div class="space-y-6">
              ...
              <a href="<?php echo e(route('admin.marketing.analytics')); ?>" class="group/btn w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white px-8 py-4 rounded-2xl flex items-center justify-center shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                <div class="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300"></div>
      ...
      <div class="group relative overflow-hidden bg-white/80 backdrop-blur-2xl rounded-3xl border border-white/30 shadow-2xl hover:shadow-3xl transition-all duration-700">
        ...
        <div class="relative">
          ...
          <div class="p-8">
            ...
            <a href="<?php echo e(route('admin.marketing.templates')); ?>" class="group/btn w-full bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white px-8 py-4 rounded-2xl flex items-center justify-center shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
              <div class="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300"></div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-slide-up">
      ...
      <div class="group relative overflow-hidden bg-white/80 backdrop-blur-2xl rounded-3xl border border-white/30 shadow-2xl hover:shadow-3xl transition-all duration-700">
        ...
        <div class="relative">
          ...
          <div class="p-8">
            <?php if($recentCampaigns->count() > 0): ?>
              <div class="space-y-4">
                ...
                <div class="group/item flex items-center justify-between p-6 bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl border border-gray-200 hover:shadow-lg hover:scale-105 transition-all duration-300">
                  <div class="flex-1">
                    <h4 class="font-bold text-gray-900 text-xl mb-2"><?php echo e($campaign->subject); ?></h4>
                    <p class="text-gray-600 text-lg"><?php echo e($campaign->recipients_count); ?> مستلم</p>
                  </div>
                  <div class="text-left">
                    <p class="text-lg font-bold text-green-600"><?php echo e($campaign->sent_at); ?></p>
                    <p class="text-sm text-gray-500"><?php echo e($campaign->status); ?></p>
                  </div>
                </div>
            ...
            <?php else: ?>
              <div class="text-center py-16">
                ...
                <a href="<?php echo e(route('admin.marketing.create')); ?>" class="group relative overflow-hidden bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white px-8 py-4 rounded-2xl inline-flex items-center shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                  <div class="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="group/template relative overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-3xl border border-blue-200 hover:shadow-2xl hover:scale-105 transition-all duration-500">
              ...
              <div class="relative">
                ...
                <a href="<?php echo e(route('admin.marketing.templates')); ?>" class="text-blue-600 text-lg font-bold hover:text-blue-700 transition-colors duration-300">استخدام القالب</a>
              </div>
            </div>
            ...
            <div class="group/template relative overflow-hidden bg-gradient-to-br from-green-50 to-emerald-50 p-8 rounded-3xl border border-green-200 hover:shadow-2xl hover:scale-105 transition-all duration-500">
              ...
              <div class="relative">
                ...
                <a href="<?php echo e(route('admin.marketing.templates')); ?>" class="text-green-600 text-lg font-bold hover:text-green-700 transition-colors duration-300">استخدام القالب</a>
              </div>
            </div>
            ...
            <div class="group/template relative overflow-hidden bg-gradient-to-br from-purple-50 to-pink-50 p-8 rounded-3xl border border-purple-200 hover:shadow-2xl hover:scale-105 transition-all duration-500">
              ...
              <div class="relative">
                ...
                <a href="<?php echo e(route('admin.marketing.templates')); ?>" class="text-purple-600 text-lg font-bold hover:text-purple-700 transition-colors duration-300">استخدام القالب</a>
              </div>
            </div>
            ...
            <div class="group/template relative overflow-hidden bg-gradient-to-br from-orange-50 to-red-50 p-8 rounded-3xl border border-orange-200 hover:shadow-2xl hover:scale-105 transition-all duration-500">
              ...
              <div class="relative">
                ...
                <a href="<?php echo e(route('admin.marketing.templates')); ?>" class="text-orange-600 text-lg font-bold hover:text-orange-700 transition-colors duration-300">استخدام القالب</a>
              </div>
            </div>
          </div>
        </div>
...
<?php echo $__env->make('layouts.dash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmed\Documents\asta\asss\resources\views/marketing/index.blade.php ENDPATH**/ ?>