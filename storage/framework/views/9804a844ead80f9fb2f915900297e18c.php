      ...
      <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 p-6 hover:scale-105 transition-all duration-300">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-blue-600"><?php echo e($totalTasks); ?></p>
          </div>
      ...
      <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 p-6 hover:scale-105 transition-all duration-300">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-green-600"><?php echo e($completedTasks); ?></p>
            <p class="text-sm text-gray-500 mt-1"><?php echo e($totalTasks > 0 ? round(($completedTasks / $totalTasks) * 100, 1) : 0); ?>%</p>
          </div>
      ...
      <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 p-6 hover:scale-105 transition-all duration-300">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-yellow-600"><?php echo e($runningTasks); ?></p>
            <p class="text-sm text-gray-500 mt-1"><?php echo e($totalTasks > 0 ? round(($runningTasks / $totalTasks) * 100, 1) : 0); ?>%</p>
          </div>
      ...
      <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 p-6 hover:scale-105 transition-all duration-300">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-red-600"><?php echo e($failedTasks); ?></p>
            <p class="text-sm text-gray-500 mt-1"><?php echo e($totalTasks > 0 ? round(($failedTasks / $totalTasks) * 100, 1) : 0); ?>%</p>
          </div>
                  ...
                  <td class="px-6 py-4">
                    <div class="flex items-center">
                      ...
                      <div class="mr-4">
                        ...
                        <div class="text-sm text-gray-500"><?php echo e($task['description']); ?></div>
                      </div>
                    </div>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap text-gray-900">
                    <code class="bg-gray-100 px-2 py-1 rounded text-sm"><?php echo e($task['schedule']); ?></code>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap text-gray-900">
                    <div class="text-sm"><?php echo e($task['last_run']->format('Y-m-d H:i')); ?></div>
                    <div class="text-xs text-gray-500"><?php echo e($task['last_run']->diffForHumans()); ?></div>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap text-gray-900">
                    <div class="text-sm"><?php echo e($task['next_run']->format('Y-m-d H:i')); ?></div>
                    <div class="text-xs text-gray-500"><?php echo e($task['next_run']->diffForHumans()); ?></div>
                  </td>
      ...
      <div class="p-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="text-center">
            <div class="text-4xl font-bold text-green-600 mb-2"><?php echo e($completedTasks); ?></div>
            <div class="text-gray-600">مهام مكتملة</div>
            <div class="w-full bg-gray-200 rounded-full h-2 mt-2">
              <div class="bg-green-500 h-2 rounded-full" style="width: <?php echo e($totalTasks > 0 ? ($completedTasks / $totalTasks) * 100 : 0); ?>%"></div>
            </div>
          </div>
          <div class="text-center">
            <div class="text-4xl font-bold text-yellow-600 mb-2"><?php echo e($runningTasks); ?></div>
            <div class="text-gray-600">مهام قيد التشغيل</div>
            <div class="w-full bg-gray-200 rounded-full h-2 mt-2">
              <div class="bg-yellow-500 h-2 rounded-full" style="width: <?php echo e($totalTasks > 0 ? ($runningTasks / $totalTasks) * 100 : 0); ?>%"></div>
            </div>
          </div>
          <div class="text-center">
            <div class="text-4xl font-bold text-red-600 mb-2"><?php echo e($failedTasks); ?></div>
            <div class="text-gray-600">مهام فشلت</div>
            <div class="w-full bg-gray-200 rounded-full h-2 mt-2">
              <div class="bg-red-500 h-2 rounded-full" style="width: <?php echo e($totalTasks > 0 ? ($failedTasks / $totalTasks) * 100 : 0); ?>%"></div>
            </div>
          </div>
        </div>
      </div>
...
<?php echo $__env->make('layouts.dash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmed\Documents\asta\asss\resources\views/reports/scheduled-tasks/index.blade.php ENDPATH**/ ?>