      ...
      <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 p-6 hover:scale-105 transition-all duration-300">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-green-600"><?php echo e(number_format($totalPayments, 2)); ?> ريال</p>
          </div>
      ...
      <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 p-6 hover:scale-105 transition-all duration-300">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-blue-600"><?php echo e(number_format($totalTransactions)); ?></p>
          </div>
      ...
      <div class="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-white/20 p-6 hover:scale-105 transition-all duration-300">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-purple-600"><?php echo e($totalTransactions > 0 ? number_format($totalPayments / $totalTransactions, 2) : 0); ?> ريال</p>
          </div>
      ...
      <div class="p-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="text-center">
            <div class="text-4xl font-bold text-green-600 mb-2"><?php echo e(number_format($paymentStatus['completed'])); ?></div>
            <div class="text-gray-600">مكتملة</div>
          </div>
          <div class="text-center">
            <div class="text-4xl font-bold text-yellow-600 mb-2"><?php echo e(number_format($paymentStatus['pending'])); ?></div>
            <div class="text-gray-600">في الانتظار</div>
          </div>
          <div class="text-center">
            <div class="text-4xl font-bold text-red-600 mb-2"><?php echo e(number_format($paymentStatus['failed'])); ?></div>
...
<?php echo $__env->make('layouts.dash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmed\Documents\asta\asss\resources\views/reports/payments/index.blade.php ENDPATH**/ ?>