        ...
        <div class="p-8 space-y-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 font-semibold"><?php echo e(config('app.name')); ?></p>
            </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <span class="inline-flex items-center px-4 py-2 rounded-xl font-semibold
                <?php echo e(config('app.env') === 'production' ? 'bg-green-100 text-green-800' : (config('app.env') === 'staging' ? 'bg-yellow-100 text-yellow-800' : 'bg-blue-100 text-blue-800')); ?>">
                <i class="ti ti-<?php echo e(config('app.env') === 'production' ? 'check-circle' : (config('app.env') === 'staging' ? 'alert-triangle' : 'info-circle')); ?> mr-2"></i>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <span class="inline-flex items-center px-4 py-2 rounded-xl font-semibold
                <?php echo e(config('app.debug') ? 'bg-orange-100 text-orange-800' : 'bg-green-100 text-green-800'); ?>">
                <i class="ti ti-<?php echo e(config('app.debug') ? 'alert-triangle' : 'check-circle'); ?> mr-2"></i>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 font-semibold text-sm break-all"><?php echo e(config('app.url')); ?></p>
            </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 font-semibold"><?php echo e(config('app.timezone')); ?></p>
            </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 font-semibold"><?php echo e(config('app.locale')); ?></p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="p-8 space-y-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 font-semibold"><?php echo e(PHP_VERSION); ?></p>
            </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 font-semibold"><?php echo e(app()->version()); ?></p>
            </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 font-semibold text-sm"><?php echo e($_SERVER['SERVER_SOFTWARE'] ?? 'غير معروف'); ?></p>
            </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 font-semibold"><?php echo e($_SERVER['HTTP_HOST'] ?? 'غير معروف'); ?></p>
            </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 font-semibold text-xs break-all"><?php echo e($_SERVER['DOCUMENT_ROOT'] ?? 'غير معروف'); ?></p>
            </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 font-semibold"><?php echo e($_SERVER['SERVER_ADDR'] ?? 'غير معروف'); ?></p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="p-8 space-y-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 font-semibold"><?php echo e(config('database.default')); ?></p>
            </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 font-semibold"><?php echo e(config('database.connections.' . config('database.default') . '.host')); ?></p>
            </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 font-semibold"><?php echo e(config('database.connections.' . config('database.default') . '.port')); ?></p>
            </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 font-semibold"><?php echo e(config('database.connections.' . config('database.default') . '.database')); ?></p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="p-8 space-y-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 font-semibold"><?php echo e(config('cache.default')); ?></p>
            </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 font-semibold"><?php echo e(config('session.driver')); ?></p>
            </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 font-semibold"><?php echo e(config('queue.default')); ?></p>
            </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
              ...
              <p class="text-gray-700 font-semibold"><?php echo e(config('mail.default')); ?></p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="p-8">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-4 border border-gray-200">
              <div class="flex items-center">
                <?php if(in_array($ext, $extensions)): ?>
                  ...
                  <span class="font-semibold text-gray-800"><?php echo e($ext); ?></span>
                <?php else: ?>
                  <i class="ti ti-x text-red-600 mr-3 text-lg"></i>
                  <span class="font-semibold text-red-600"><?php echo e($ext); ?></span>
                <?php endif; ?>
              </div>
            </div>
          ...
          <div class="text-center">
            <button class="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-2xl font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl" 
              ...
              <i class="ti ti-eye mr-2"></i>عرض جميع الإضافات (<?php echo e(count($extensions)); ?>)
            </button>
          </div>
          ...
          <div id="allExtensions" class="hidden mt-6">
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
              ...
              <div class="bg-gray-100 rounded-lg p-2 text-center">
                <span class="text-gray-600 text-sm font-medium"><?php echo e($extension); ?></span>
              </div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
          </div>
        ...
        <div class="p-8">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-gradient-to-r from-blue-50 to-blue-100 rounded-2xl p-6 border border-blue-200 text-center">
              ...
              <h2 class="text-3xl font-bold text-blue-600"><?php echo e(\App\Models\User::count()); ?></h2>
            </div>
            ...
            <div class="bg-gradient-to-r from-green-50 to-green-100 rounded-2xl p-6 border border-green-200 text-center">
              ...
              <h2 class="text-3xl font-bold text-green-600"><?php echo e(\App\Models\Course::count()); ?></h2>
            </div>
            ...
            <div class="bg-gradient-to-r from-purple-50 to-purple-100 rounded-2xl p-6 border border-purple-200 text-center">
              ...
              <h2 class="text-3xl font-bold text-purple-600"><?php echo e(\DB::table('course_user')->count()); ?></h2>
            </div>
            ...
            <div class="bg-gradient-to-r from-orange-50 to-orange-100 rounded-2xl p-6 border border-orange-200 text-center">
              ...
              ?>
              <h2 class="text-3xl font-bold text-orange-600"><?php echo e($storageSize ? $storageSize . ' GB' : 'غير معروف'); ?></h2>
            </div>
          </div>
        </div>
      </div>
...
function toggleExtensions() {
  ...
  if (extensionsDiv.classList.contains('hidden')) {
    ...
    button.innerHTML = '<i class="ti ti-eye mr-2"></i>عرض جميع الإضافات (<?php echo e(count($extensions)); ?>)';
  }
}
</script>
