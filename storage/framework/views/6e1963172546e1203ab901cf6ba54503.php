  ...
  <div class="space-y-8 p-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between animate-fade-in">
      ...
      <div class="mt-4 sm:mt-0">
        <a href="<?php echo e(route('partners.create')); ?>" 
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          <?php $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="hover:bg-gray-50 transition-colors duration-200">
              <td class="px-6 py-4 whitespace-nowrap font-medium text-gray-900" style="font-size: 1.3rem;"><?php echo e($partner->id); ?></td>
              <td class="px-6 py-4 whitespace-nowrap">
                <?php if($partner->image): ?>
                <div class="flex items-center">
                  <img src="<?php echo e(asset($partner->image)); ?>" 
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div>
                  <div class="font-medium text-gray-900" style="font-size: 1.3rem;"><?php echo e($partner->name); ?></div>
                  <?php if($partner->description): ?>
                  <div class="text-gray-500" style="font-size: 1.3rem;"><?php echo e(Str::limit($partner->description, 50)); ?></div>
                  <?php endif; ?>
                </div>
              </td>
              <td class="px-6 py-4 whitespace-nowrap">
                <?php if($partner->website): ?>
                <a href="<?php echo e($partner->website); ?>" target="_blank" class="inline-flex items-center text-blue-600 hover:text-blue-800 transition-colors duration-200">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-gray-900">
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full font-medium bg-blue-100 text-blue-800" style="font-size: 1.3rem;">
                  <?php echo e($partner->sort_order ?? 0); ?>
              ...
              <td class="px-6 py-4 whitespace-nowrap font-medium" style="font-size: 1.3rem;">
                <div class="flex items-center space-x-2 space-x-reverse">
                  ...
                  <a href="<?php echo e(route('partners.edit', $partner)); ?>" 
                  ...
                  <form action="<?php echo e(route('partners.destroy', $partner)); ?>" method="POST" class="inline" onsubmit="return confirm('هل أنت متأكد من حذف هذا الشريك؟')">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmed\Documents\asta\asss\resources\views/partners/index.blade.php ENDPATH**/ ?>