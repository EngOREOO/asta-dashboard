            ...
            <table class="w-full">
              ...
              <tbody>
                ...
                <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200">
                  ...
                  <!-- User Name -->
                  <td class="py-4 px-6">
                    <div class="font-semibold text-gray-800"><?php echo e($testimonial->user_name); ?></div>
                    <div class="text-sm text-gray-500"><?php echo e($testimonial->created_at->format('Y-m-d')); ?></div>
                  </td>
                  ...
                  <td class="py-4 px-6">
                    <div class="flex items-center">
                      <?php for($i = 1; $i <= 5; $i++): ?>
                        ...
                        <?php endif; ?>
                      <?php endfor; ?>
                      <span class="mr-2 text-gray-600 font-semibold"><?php echo e($testimonial->rating); ?>/5</span>
                    </div>
                  </td>
                  ...
                  <td class="py-4 px-6">
                    <div class="max-w-xs">
                      <p class="text-gray-700 text-sm line-clamp-2"><?php echo e(Str::limit($testimonial->comment, 100)); ?></p>
                    </div>
                  </td>
                  ...
                  <td class="py-4 px-6">
                    <div class="flex items-center space-x-2 rtl:space-x-reverse">
                      <!-- View -->
                      <a href="<?php echo e(route('testimonials.show', $testimonial)); ?>" 
                      ...
                      <button onclick="toggleApproval(<?php echo e($testimonial->id); ?>)" 
                              class="bg-<?php echo e($testimonial->is_approved ? 'yellow' : 'green'); ?>-100 text-<?php echo e($testimonial->is_approved ? 'yellow' : 'green'); ?>-600 p-2 rounded-lg hover:bg-<?php echo e($testimonial->is_approved ? 'yellow' : 'green'); ?>-200 transition-colors duration-200"
                              title="<?php echo e($testimonial->is_approved ? 'إلغاء الموافقة' : 'الموافقة'); ?>">
                        <i class="ti ti-<?php echo e($testimonial->is_approved ? 'ban' : 'check'); ?>"></i>
                      </button>

                      <!-- Toggle Featured -->
                      <button onclick="toggleFeatured(<?php echo e($testimonial->id); ?>)" 
                              class="bg-<?php echo e($testimonial->is_featured ? 'gray' : 'purple'); ?>-100 text-<?php echo e($testimonial->is_featured ? 'gray' : 'purple'); ?>-600 p-2 rounded-lg hover:bg-<?php echo e($testimonial->is_featured ? 'gray' : 'purple'); ?>-200 transition-colors duration-200"
                              title="<?php echo e($testimonial->is_featured ? 'إلغاء التمييز' : 'تمييز'); ?>">
                        <i class="ti ti-star"></i>
                      </button>

                      <!-- Delete -->
                      <form action="<?php echo e(route('testimonials.destroy', $testimonial)); ?>" method="POST" class="inline"
...
<?php echo $__env->make('layouts.dash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahmed\Documents\asta\asss\resources\views/testimonials/index.blade.php ENDPATH**/ ?>